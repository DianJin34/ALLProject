...
function loadJSONFile(resolvedName) {
  ...
  const jsonContent = fs.readFileSync(resolvedName, 'utf8'); 
  const parsedJSON = JSON.parse(jsonContent);

  require_._cache[resolvedName] = parsedJSON;
  return require_._cache[resolvedName];
  /** </FILL-IN> **/
}
...
require_.loader = ((orgloader) =>
{
  return (resolvedName, nextLoader) => 
  {
    ...
    {
      return orgloader(resolvedName, nextLoader);
    }
  }
})(require_.loader);